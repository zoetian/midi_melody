function mplay(canvas,notes)
{
	...
	let scale = canvas.width / (7 * keyWidthBase * octaves);
	let octave_width = scale * keyWidthBase * 7;
	let octave_height = scale * keyHeightBase;
	let octave_y = canvas.height - octave_height;
	let play_line = octave_y / speed;
	let white_key_width = keyWidthBase * scale;
	let black_key_width = blackKeyWidthBase * scale;
